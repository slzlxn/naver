...
pw2.addEventListener("focusout", comparePw); //함수자체를 넣어야지 ()까지 넣으면 포커스 아웃안해도 알아서 실행됨
...
/* id.addEventListener("focusout", checkPw); */
...
function checkId() {
  ...
  if (id.value === "") {
    ...
    error[0].innerHTML =
      "5~20자의 영문 소문자, 대문자, 숫자와 특수기호(_),(-)만 사용가능합니다.";
    error[0].style.display = "block";
    error[0].style.color = "#f00";
  } else {
...
function isEmailCorrect(){
  var emailPattern=/[a-zA-Z0-9]{2,}@[a-zA-z]{2,}\.[a-zA-z]{2,}/;
  if(email.value == ""){
